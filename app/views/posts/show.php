                ...
                <div class="col-md-12 content-page">
                  <div class="col-md-12 blog-post">
                    ...
                    <div><a href="posts/<?php echo $post['postId'] ?>/<?php echo \Core\Functions\slugify($post['title']); ?>/editform.html" type="button" class="btn btn-primary">Edit Post</a>
                      <a href="posts/<?php echo $post['postId'] ?>/<?php echo \Core\Functions\slugify($post['title']); ?>/delete.html"type="button"class="btn btn-secondary"role="button" class="delete">Delete Post</a>
                    </div>
                    <!-- Post Buttons End -->
                  </div>
                </div>
